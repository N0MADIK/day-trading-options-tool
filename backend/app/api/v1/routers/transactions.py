"""Transactions API router - Simple delegator to personal finance transactions"""
...
from app.schemas.personal_finance import TransactionListRequest
...
async def list_user_transactions(
    ...
    """
    List transactions for the current user's connected accounts.
    Delegates to personal_finance.transactions_router.
    """
